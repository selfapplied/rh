...
from visualization.create_github_3_5d_badge import (
    create_github_3_5d_badge, create_detailed_github_badge, 
    create_compact_multi_metric_badge, create_shield_style_badge
)
...
def cert(
    ...
    if cert_type == "passport":
        ...
        runner = CliRunner()
        result = runner.invoke(app, ["badge", "--github", "--detailed"])
    else:
...
def handle_contextual_rie():
    ...
    last_command = recent_activity[-1]['command']
