...
### Proposition (Local Linearization)
...
### Part 1: Image Subgroup Structure
...
### Part 4: Chiral Edge Attraction and Mirror Symmetry
...
2. **Energy conservation**: The Toeplitz/Schur recursion requires rank-one updates, which occur naturally at edge coincidences
3. **Phase locking**: The collapsed direction creates a resonant seam where different "worldlines" intersect
4. **Mirror symmetry**: The loci where $2^k \mid (\delta A + \gamma)$ act as modular mirror seams joining left- and right-handed sectors
...
### Hinge and Pleat Geometry of Modular Chirality
...
2. **Fourier analysis**: Sharp peaks at $k = 128$ (mod-2 character correlation)
3. **Coefficient fit**: $\delta A + \gamma$ divisible by high power of 2
