...
class MathematicalLedger:
    ...
    def _generate_summary(self) -> Dict[str, Any]:
        ...
        # Find key constants
        [entry for entry in self.ledger if 'C_A' in entry.semantic_reason]
        [entry for entry in self.ledger if 'C_P' in entry.semantic_reason]
        [entry for entry in self.ledger if 'threshold' in entry.semantic_reason]
...
def main():
    ...
    ledger.verify_block_positivity_with_ledger(threshold_id)
    print()
