...
try:
    from create_axiel_badge import (
        ColorQuaternionGroup as BadgeColorQuaternionGroup,
        sha256_to_oklch_ambient_palette,
...
try:
    from ce1_core import CE1Kernel, TimeReflectionInvolution, UnifiedEquilibriumOperator
